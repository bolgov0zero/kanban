...
echo ""
echo -e "\e[33m================================\e[0m"
echo -e "\e[33mKanban Panel Dev - Система задач\e[0m"
echo -e "\e[33m================================\e[0m"
echo ""
...
services:
  web:
    image: bolgov0zero/kanban-panel:dev
...
# Этап 2: Создание скрипта управления 'kanban' (без sudo, в ~/bin)
sleep 1
...
if [ ! -d "$KANBAN_DIR" ]; then
    echo "Ошибка: Директория $KANBAN_DIR не найдена. Укажите правильный путь или запустите из установки."
    exit 1
fi
...
clear
echo -e "\e[33m=======================\e[0m"
echo -e "\e[33mСкрипт Kanban Panel Dev\e[0m"
echo -e "\e[33m=======================\e[0m"
echo ""
...
REMOTE_VERSION=$(curl -s https://raw.githubusercontent.com/bolgov0zero/kanban-panel/refs/heads/dev/version.json | jq -r '.version')
...
echo ""
echo -e "\e[32mАдрес панели:\e[0m https://${HOST_IP}/"
